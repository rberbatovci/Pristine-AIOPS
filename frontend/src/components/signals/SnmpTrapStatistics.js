...
function SnmpTrapSignalsStatistics({ currentUser, setDashboardTitle, keycloak, showNotification, selectedTags = [] }) {
    ...
    useEffect(() => {
        ...
        const fetchStatistics = async (dataType) => {
            ...
            const endpoint = `/signals/snmptraps/statistics/${dataType}`;
...
export default SnmpTrapSignalsStatistics;