...
function TelemetrySignalsStatistics({ currentUser, setDashboardTitle, keycloak, showNotification, selectedTags = [] }) {
    ...
    useEffect(() => {
        ...
        const fetchStatistics = async (dataType) => {
            ...
            const endpoint = `/signals/telemetry/statistics/${dataType}`;
...
export default TelemetrySignalsStatistics;