...
function SyslogEventsTable({ currentUser, setDashboardTitle, showNotification, keycloak }) {
    ...
    console.log("Timezone in Syslog Events:", currentUser.timezone);
    console.log("User Preferences:", preferences);

    useEffect(() => {
        console.log("Selected tags in Syslog Events:", selectedTags);
    }, [selectedTags]);
...
export default SyslogEventsTable;