...
import SnmpTrapEvents from './SnmpTrapEvents.js';

function SnmpTrapSignals({ currentUser, setDashboardTitle, showNotification, keycloak }) {
...
export default SnmpTrapSignals;